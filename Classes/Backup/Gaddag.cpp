						...
						if(checkAnchor(i,j) == 1)
						{
							...
							for(direction = 1 ; direction <=2 ; direction++)
							{
								...
								if(direction == 2)
								{
									...
									if(papan.getLetterOnPosition(papan.getRowPLayed() + 1,papan.getColPlayed()) != '-' && papan.getRowPLayed() + 1 < 15)
									{
										while(status == 0)
										{
								...
								else
								{
									...
									if(papan.getLetterOnPosition(papan.getRowPLayed(),papan.getColPlayed() + 1) != '-' && papan.getColPlayed() + 1 < 15)
									{
										while(status == 0)
										{
